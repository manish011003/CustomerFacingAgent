...
6. **Architecture** — Next.js customer UI + FastAPI + policy engine + Elasticsearch/JSON KB. LLM optional. Diagram from [docs/system-architecture.md](system-architecture.md).
